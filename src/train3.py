...
for file in sorted(os.listdir(MODEL_DIR)):
    if file.startswith("model_checkpoint_") and file.endswith(".pth"):
        latest_checkpoint = os.path.join(MODEL_DIR, file)
...
for epoch in range(epochs):
    ...
    checkpoint_path = os.path.join(MODEL_DIR, f"model_checkpoint_{epoch+1}.pth")
